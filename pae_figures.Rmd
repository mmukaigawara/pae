...
nigeria_other_violence <- read_csv("2020-01-01-2020-07-31-Nigeria.csv") #ACLED, other types of violence, Jan to Jul
nigeria_ebola <- read_csv("2014-01-01-2021-12-31-Nigeria.csv") #ACLED 2014, to examine Ebola
...
The main data are downloadable from the ACLED website (requires registration). To perform a replication analysis, one needs to download data from the ACLED website with following restrictions:
...
- Data for year 2018
  ...
  - Country: Nigeria
- Data for years 2017-2000 (Use similar restrictions as above. Contact ACLED to obtain full access to old data.)
